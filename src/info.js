...
export const PROFILE = {
    ...
    blurb: "Software Engineer with over a year of experience building full-stack applications, from API design through deployment, with a growing focus on backend systems and architecture.",
